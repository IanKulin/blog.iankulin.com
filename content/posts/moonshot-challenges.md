...
One of the [SwiftLint](/tags/swiftlint/) rules is about the length of views, and I recall Paul Hegarty saying something in the first couple of CS193p lectures about views needing to be kept short. I never know the pros and cons of extracting parts of them as a function or as another struct. And if I do extract them as a struct, it always seems odd to me to just be able to "call" a struct exactly as a function - although since this is declarative programming and we're just describing a view I guess it's fine.

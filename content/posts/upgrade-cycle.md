...
![](/images/screen-shot-2023-01-26-at-3.47.47-pm-2.png)
...
The rationalisation is that even with both, I've only spent the same as a single Pi4 for a lot more computing power, and I could _in theory_ sell the first one (trying to get a licensed Windows back on to it could be an interesting challenge).
...
![](/images/screen-shot-2023-01-26-at-4.07.13-pm.png)

...
So I ordered an 2.5" SDD in order to resurrect the MacBook. This era (2012) of MacBooks are quite repairable - even the RAM is just regular SODIMM.

### Instructions

Lay it upside down and remove the screws with a tiny (I guess #00) Philips screwdriver. Note that the screws don't come out perpendicular to the table you're working on - the top four almost do, but the others are perpendicular to the tangent at the point of the screw hole. ie, the case is curved, so take that into account. It doesn't matter much for removing them, but now is the time to notice.

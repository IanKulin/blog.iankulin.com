...
![young women identical twins enjoying the beach unreal engine - midjourney](/images/pucker_young_women_identical_twins_enjoying_the_beach_unreal_en_89773710-ae61-42d7-bede-d74ef60dafd3.png)
...
I also listen to a few podcasts about the subject. Often good podcasts seem to get more detailed and technical over time, so I search for any that do occasional episodes on beginner topics. Even if a lot of it is over my head, you do start to pick up on the industry buzz about things, and learn some of the names that can be helpful for searches later. I'm currently cherry picking old episodes of [JavaScript Jabber](https://topenddevs.com/podcasts/javascript-jabber).

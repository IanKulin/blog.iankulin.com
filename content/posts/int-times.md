...
When writing [yesterday's post](https://devendevour.wordpress.com/?p=574) about iterating through a range or collection and using the underscore to throw away the item, I had in the back of my mind that there should be a more straightforward way of doing something a number of times.
